...
function DrawCuteLittleFlower(x, y, maxSize, growthRate) {
  this.x = x;
  this.y = y;
  ...
  this.flowerWidth = 3;
  this.flowerHeight = 9;
  this.flowerColor = R.random_choice(chosenPalette);
  this.flowerCenterColor = R.random_choice(chosenPalette);
